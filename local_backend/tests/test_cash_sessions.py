...
def session_fixture():
    ...
    with Session(engine) as session:
        ...
        pm1 = PaymentMethodModel(code="pm_efectivo_usd", name="Efectivo USD", currency="USD", is_active=True)
        pm2 = PaymentMethodModel(code="pm_pago_movil", name="Pago Móvil", currency="VES", is_active=True)
        session.add(pm1)
        session.add(pm2)
